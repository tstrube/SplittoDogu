...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GM] = LAYOUT(
        ...
        TSW_LCK,KC_CAPS,KC_APP ,TO(_MC),MO(_FN),KC_LGUI,KC_LALT,KC_SPC ,KC_BSPC,MO(_FN),TG(_FN),KC_LOCK,TO(_DF),KC_MPLY,KC_MNXT,KC_MUTE
    ),
    [_FN] = LAYOUT(
        ...
        _______,_______,_______,KC_LEFT,KC_DOWN,KC_RGHT,_______,_______,_______,KC_PDOT,KC_P4  ,KC_P5  ,KC_P6  ,KC_PPLS,KC_PAST,_______,
        _______,_______,_______,_______,_______,_______,_______,_______,_______,KC_P0  ,KC_P1  ,KC_P2  ,KC_P3  ,KC_PENT,_______,_______,
